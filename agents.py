...
# Shared tool instance (created once, reused by all agents)
...
def create_cpc_agent() -> Agent:
    return Agent(
        ...
        tools=[CPCSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_crpc_agent() -> Agent:
    return Agent(
        ...
        tools=[CrPCSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_divorce_agent() -> Agent:
    return Agent(
        ...
        tools=[DivorceSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_environ_agent() -> Agent:
    return Agent(
        ...
        tools=[EnvironSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_marriage_agent() -> Agent:
    return Agent(
        ...
        tools=[MarriageSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_mva_agent() -> Agent:
    return Agent(
        ...
        tools=[MVASearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_evidence_agent() -> Agent:
    return Agent(
        ...
        tools=[EvidenceSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_administrative_agent() -> Agent:
    return Agent(
        ...
        tools=[AdministrativeSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_banking_agent() -> Agent:
    return Agent(
        ...
        tools=[BankingSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_bankruptcy_agent() -> Agent:
    return Agent(
        ...
        tools=[BankruptcySearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_company_law_agent() -> Agent:
    return Agent(
        ...
        tools=[CompanyLawSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_copyright_agent() -> Agent:
    return Agent(
        ...
        tools=[CopyrightSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_corporate_practice_agent() -> Agent:
    return Agent(
        ...
        tools=[CorporatePracticeSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_design_law_agent() -> Agent:
    return Agent(
        ...
        tools=[DesignLawSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_human_rights_agent() -> Agent:
    return Agent(
        ...
        tools=[HumanRightsSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_information_technology_agent() -> Agent:
    return Agent(
        ...
        tools=[InformationTechnologySearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_minimum_wages_agent() -> Agent:
    return Agent(
        ...
        tools=[MinimumWagesSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_patent_agent() -> Agent:
    return Agent(
        ...
        tools=[PatentSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_property_law_agent() -> Agent:
    return Agent(
        ...
        tools=[PropertyLawSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_tax_law_agent() -> Agent:
    return Agent(
        ...
        tools=[TaxLawSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
...
def create_trademark_law_agent() -> Agent:
    return Agent(
        ...
        tools=[TrademarkLawSearchTool(), _sc_tool], verbose=False, max_iter=3
    )
